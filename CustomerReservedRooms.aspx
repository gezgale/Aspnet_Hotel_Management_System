<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CustomerReservedRooms.aspx.cs" Inherits="CustomerReservedRooms" %>
        ...
        <tr>
            ...
            <td style="height: 21px; text-align: center">
                <asp:Label ID="Label11" runat="server" Font-Bold="True" Font-Names="Tahoma" Font-Size="16pt"
                    ForeColor="#400000" Style="margin-top: 20px" Text="اتاقهای رزرو شده توسط مشتری"></asp:Label></td>
            <td style="height: 21px">
            </td>
        </tr>
        <tr>
...
<center>
    <asp:DataList ID="DtLstRooms" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" style="font-size: medium">
        <ItemTemplate>
            ...
            <table width="100%" class="table-bordered">
                <tr>
                    <td>
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "~/CancelRezerveRoom.aspx?ID=" + Eval("RoomID") %>' Text='<%# "لغو رزرو" + " - کدر رزرو: (" + Eval("ReserveCode") + ")" %>'></asp:HyperLink>
                    </td>
                </tr>
            </table>
